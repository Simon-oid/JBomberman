...
public class ExitTile extends Tile
{
    ...
    /**
     * Method to finish the level when the exit tile is reached.
     * You can implement the logic to transition to the next level or end the game here.
     */
...
//        }
    ...
    /**
     * Method to spawn an IceCreamPowerUp on an adjacent tile when the exit tile is hit by a bomb explosion.
     */
    public void spawnIceCreamPowerUp()
    {
        ...
        if (isHitByBombExplosion())
        {
            ...
            if (adjacentTile != null)
            {
                ...
                PowerUp spawnedPowerUp = new IceCreamPowerUp();
    ...
    /**
     * Helper method to check if the tile is hit by a bomb explosion.
     * You need to implement the logic to detect bomb explosions and collisions with this tile.
     *
