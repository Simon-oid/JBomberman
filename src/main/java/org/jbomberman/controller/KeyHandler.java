    ...
    private void createTimer()
    {
...

        {
            ...
            public void handle(long now)
            {
                ...
                int yStep = (int) (delta * Map.getInstance().getPlayer().getSpeed() * ((upPressed ? -1 : 0) + (downPressed ? 1 : 0)));

                int xStep = (int) (delta * Map.getInstance().getPlayer().getSpeed() * ((leftPressed ? -1 : 0) + (rightPressed ? 1 : 0)));
